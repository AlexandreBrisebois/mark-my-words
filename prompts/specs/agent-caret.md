...
- **Auto-quick mode**: Skips Phase 1 (Compass), Phase 3.5 (audience signal), Phase 4 (Mark headlines), Phase 5 (Mark loop), Phase 6+7 (Devil+Echo), Phase 8, and Phase 8.5. Logs each skip in status.md as `[skip] Phase N — auto-quick mode`. Runs: Phase 0 (Index), Phase 2 (Turing — single focused search), Phase 3 (Caret draft from brief + research; no compass-notes.md available), Phase 9+10 (Press + Prism), mmw:proof gate, Phase 11. See flow.md § Auto Quick Flow.
