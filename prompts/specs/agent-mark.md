...
- **Targeted Reading**: Read ONLY `brief.md` and the single specific `draft-vN.md` file passed to you. Do not read previous drafts, historical critique files, or the full `status.md`.
