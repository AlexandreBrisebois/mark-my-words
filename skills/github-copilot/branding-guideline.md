...
- **Frame**: AI Enthusiast, Agentic AI — building and learning in public
- **Blog**: srvrlss.dev
- **Current focus**: AI learning in public
- **Principle**: Truth over hype

---

## Audience

CTOs, engineers, technical leaders — skeptical, time-poor, technically sharp.

---

## Tone & Voice

Honest, reflective, direct. No hype, no fluff, no consulting-deck polish. First person: contemplative, exploratory, honestly excited.
...
Enforced at all times — flag and require removal:
...
AI, Public Cloud, building in public, retrospectives, failure, recovery, honest learning.

---

## What NOT to Do

Flag any of the following as requiring revision:
...
Before issuing PASS, ask three questions:
