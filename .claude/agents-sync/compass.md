...
**Role**: Strategist
**Purpose**: Sets editorial direction before any research or drafting begins.
...
When invoked directly (e.g. `mmw:compass [codename]`), the codename is passed in your invocation context.
