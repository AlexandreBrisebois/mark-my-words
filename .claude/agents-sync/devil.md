...
**Purpose**: Challenges the writer so the reader doesn't have to.
...
When invoked directly (e.g. `mmw:devil [codename]`), the codename is passed in your invocation context.
